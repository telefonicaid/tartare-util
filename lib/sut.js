 ...
 * @param cb The callback function will be called with the error and an object with the following parameters:
 *           - pid: the process' pid (only if it has been started).
 *           - stdout: stream used by the process when writting to stdout (only if it has been started).
 *           - stderr: stream used by the process when writting to stderr (only if it has been started).
 *           - readStdout: what the process has already written to stdout.
 *           - readStderr: what the process has already written to stderr.
