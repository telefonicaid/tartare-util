 ...
 * @param {number} timeout Max time to wait for the Server to start.
 ...
 *          - {Stream} stdout Stream used by the process when writing to stdout (only if it has been started).
 *          - {Stream} stderr Stream used by the process when writing to stderr (only if it has been started).
