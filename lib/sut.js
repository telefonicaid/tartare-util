 ...
 *   - {ReadableStream} stdout A Readable Stream that represents the process' stdout (only if it has been started).
 *   - {ReadableStream} stderr A Readable Stream that represents the process' stderr (only if it has been started).
 *   - {WritableStream} stdin A Writable Stream that represents the child process' stdin (only if it has been started).
